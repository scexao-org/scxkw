...
elif os.environ['WHICHCOMP'] == '6':
    GEN2PATH_PRELIM = "/mnt/tier1/PRE_ARCHIVE_DATA/" # <- ARCHIVE in here # OBSOLETE
...
elif os.environ['WHICHCOMP'] == '5':
    GEN2PATH_PRELIM = "/mnt/fuuu/PRE_ARCHIVE_DATA/" # <- ARCHIVE in here # OBSOLETE
